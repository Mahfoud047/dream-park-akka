...
trait DefaultApiService {
   ...
   * Code: 422, Message: Unexpected error, DataType: Error
   */
  def reservationPost(body: Reservation)
   ...
   * Code: 422, Message: Unexpected error, DataType: Error
   */
  def reservationReservationIdSettlePut(body: Object, reservationId: Int)
      (implicit toEntityMarshallerError: ToEntityMarshaller[Error], toEntityMarshallerError: ToEntityMarshaller[Error]): Route

}

trait DefaultApiMarshaller {
  implicit def fromRequestUnmarshallerReservation: FromRequestUnmarshaller[Reservation]

  implicit def fromRequestUnmarshallerObject: FromRequestUnmarshaller[Object]
